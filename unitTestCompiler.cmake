...
macro(setStandardFlagsForUnitTest debugLevel codeOptimization )
    ...
    SET(DEFAULT_CODE_OPTIMIZATION "${DEFAULT_CODE_OPTIMIZATION} -fsigned-char -fsingle-precision-constant -fmessage-length=0 -flto  -fno-inline" )
    ...
    SET(LINKER_GENERAL "--gc-sections ")
endmacro()