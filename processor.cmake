...
function(setTargetFlags processor)
  ...
  set(cortexM4 STCOMET10 STM32F334x8 stm32F429xx)
  ...
  elseif( processor IN_LIST cortexM3)
    ...
    SET(TARGET_FLAGS " -march=ARMv7-M -mcpu=cortex-m3 -mthumb -mfloat-abi=soft -munaligned-access  ${CMAKE_CXX_FLAGS} " PARENT_SCOPE)
    add_definitions(-DCORTEX_USE_FPU=0)
